...
def getNewWindAndSolarCFs(genFleet,currYear,modelName,tzAnalysis,runLoc,resultsDir,
    ...
    (windCFs,windCfsDtHr,windCfsDtSubhr,windIdAndCapac,solarCFs,solarCfsDtHr,solarCfsDtSubhr,
        ...
        solarCapacInCurrFleet,tzAnalysis,runLoc,windGenDataYr,
...
def trimNewRECFsToCEHours(zonalNewWindCFs,zonalNewSolarCFs,hoursForCE):
    ...
    for zone in zonalNewWindCFs:
        newWindCFsCEZonal[zone] = [zonalNewWindCFs[zone][hr-1] for hr in hoursForCE] #-1 b/c hours in year start @ 1, not 0 like Python idx
