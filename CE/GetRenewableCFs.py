...
def wrappersolar(site):
    ...
    :param site: a list with arguments for function getWindSiteCfs_2
    :return: list with:
                    - 1d list with hourly CFs for wind site
                    - 1d list with subhourly CFs for wind site
...
def getRenewableCFs(genFleet, startWindCapacForCFs, startSolarCapacForCFs, desiredTz, dataRoot, windGenDataYr, currZone,
                    fipsToZones, fipsToPolys, subHour=False, ncores_py=1):
