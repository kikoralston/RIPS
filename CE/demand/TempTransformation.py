#Obtained from Francisco on 8/3/17
#Script has functions that break temperature into bins, and
#convert relative humidity to dew point. Both necessary for regressions
#that predict demand from temperature & RH.
